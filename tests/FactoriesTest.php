...
class FactoriesTest extends TestCase
{
    ...
    public function testGregorianDate(): void
    {
        ...
        $date2 = Calendar::create(2024, Month::February, 25); // use enum for a month
    ...
    {
        $date1 = Calendar::create(-5120, 5, 13);
        $date2 = Calendar::create(-5120, Month::May, 13); // use enum for a month
    ...
    public function testGregorianDateWrongDay(): void
    {
        ...
        Calendar::create(2000, 11, 33);
    }

    public function testParser(): void
    {
        // positive year
        $date = Calendar::parse('2025-2-25');
    ...
    public function testParserInvalidFormat(): void
    {
        ...
        Calendar::parse('2015/12/12'); // Only Y-m-d is accepted
    }
